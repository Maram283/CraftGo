    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: _BottomBar(
          ...
          price: price,
          quantity: _quantity,
          onAddToCart: widget.isGuest
              ? _showGuestPrompt
              : () => _showSnack(t('أُضيف إلى السلة', 'Added to cart')),
          onBuyNow: widget.isGuest
              ? _showGuestPrompt
              : () => _showSnack(
                  t('جارٍ التوجه للدفع...', 'Going to checkout...'),
                ),
        ),
                  ...
                  children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                isArabic ? '95% صديق للبيئة 🌿' : '95% Eco-Friendly 🌿',
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () => _showARSimulation(context),
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => import_chat.AiChatbotScreen(
                                    ...
                                    productName: name,
                                    productPrice: price,
                                    productIcon: p["icon"] as IconData?,
                                  ),
                                ),
                              );
                            },
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    t(_artisan["nameAr"], _artisan["nameEn"]),
                                    style: TextStyle(
                                      color: text,
                                      fontSize: 14,
                                  ...
                                  Text(
                                    t(_artisan["craftAr"], _artisan["craftEn"]),
                                    style: TextStyle(
                                      color: accent,
                                      fontSize: 12,
                                    ),
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _Chip(
                          label: t('مستلزمات المنزل', 'Home Décor'),
                          accent: accent,
                          surface: surface,
                          border: border,
                          text: text,
                      ...
                      child: Column(
                        children: [
                          ...
                          _InfoRow(
                            ...
                            value: t('نابلس، فلسطين', 'Nablus, Palestine'),
                            text: text,
                            dim: dim,
                            accent: accent,
                          ),
                ...
                Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Icon(
                        widget.product['icon'] as IconData? ?? Icons.inventory_2_outlined,
                        size: 120,
