...
import '../screens/artisan/craftsman_offers_screen.dart'; // NEW
...
class _CraftsmanShellState extends State<CraftsmanShell> {
  ...
  // New tab titles: removed "Projects", added "My Offers"
  ...
  List<Widget> get _pages => [
    ...
    // NEW: My Offers screen
    CraftsmanOffersScreen(
      isArabic: _isArabic,
      isDarkMode: _isDarkMode,
      artisanId: 'artisan-fatima', // in real app, get from auth
    ),
