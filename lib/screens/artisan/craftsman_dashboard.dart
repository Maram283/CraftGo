...
import 'craftsman_offers_screen.dart'; // new
...
class _CraftsmanDashboardState extends State<CraftsmanDashboard> {
  // ── Theme getters (always use widget values) ──────────────────────
  ...
  void _goToTemplates() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ArtisanTemplatesScreen(
          isArabic: isArabic,
          isDarkMode: isDarkMode,
          artisanId: 'artisan-amjad', // TODO: real ID
        ),
      ),
    );
  }
  ...
  void _goToOffers() {
    // Navigate to the "My Offers" tab by popping and changing the shell index?
    // For simplicity, we just push a new screen (or use a route).
    // Since the shell manages tabs, we can use a named route or just push.
    // Here we push the screen directly (this will add it on top).
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  void _addNewWork() {
    // Show a simple dialog to add a new portfolio item (placeholder)
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(t('إضافة عمل جديد', 'Add New Work'),
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                labelText: t('اسم العمل', 'Work Name'),
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: InputDecoration(
                labelText: t('وصف مختصر', 'Brief Description'),
                labelStyle: TextStyle(color: secondaryTextColor),
              ),
            ),
          ],
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(t('تمت إضافة العمل بنجاح ✅', 'Work added successfully ✅')),
                  backgroundColor: Colors.green,
                ),
              );
            },
            style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFD4A017)),
            child: Text(t('حفظ', 'Save'), style: const TextStyle(color: Colors.black)),
          ),
        ],
      ),
    );
  ...
  void _submitBid() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(t('سيتم فتح نموذج تقديم العرض', 'Bid form will open')),
  ...
  Widget build(BuildContext context) {
    ...
    final activeCategory = isArabic ? widget.categoryTitleAr : widget.categoryTitleEn;
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  if (widget.isVerified) ...[
                                    ...
                                    const Icon(Icons.verified, color: Color(0xFFD4A017), size: 18),
                                  ],
                                ],
                              ),
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(widget.city, style: TextStyle(color: secondaryTextColor, fontSize: 12)),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: const Color(0xFFD4A017).withValues(alpha: 0.4), width: 1),
                                ),
                                child: Text(
                                  activeCategory,
                                  style: const TextStyle(color: Color(0xFFD4A017), fontSize: 12, fontWeight: FontWeight.bold),
                                ),
                              ),
                            ],
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          isArabic ? "معرض أعمالك المميزة" : "Your Featured Portfolio",
                        ...
                        TextButton.icon(
                          ...
                          icon: Icon(Icons.add_circle_outline, color: const Color(0xFFD4A017), size: 18),
                          label: Text(
                            t('إضافة', 'Add'),
                            style: TextStyle(color: const Color(0xFFD4A017), fontWeight: FontWeight.bold),
                          ),
                        ),
                      ],
                    ),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.storefront_outlined, color: Color(0xFFD4A017), size: 24),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  t('إدارة عروضي', 'Manage My Offers'),
                                  style: GoogleFonts.cairo(
                                    color: primaryTextColor,
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                ...
                                Text(
                                  t('منتجات جاهزة، قوالب مخصصة، وخدمات في الموقع', 'Ready-made, custom templates, and on-site services'),
                                  style: GoogleFonts.cairo(
                    ...
                    // 2. Custom Templates (already exists)
                    Container(
                      padding: const EdgeInsets.all(16),
                      margin: const EdgeInsets.only(bottom: 12),
                      decoration: BoxDecoration(
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.palette_outlined, color: Color(0xFFD4A017), size: 24),
                          ),
                          const SizedBox(width: 14),
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  t('إدارة قوالب الطلبات المخصصة', 'Manage Custom Order Templates'),
                                  style: GoogleFonts.cairo(
                                    color: primaryTextColor,
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                ...
                                Text(
                                  t('أنشئ قوالب ليتمكن الزبائن من تقديم طلبات مخصصة', 'Create templates for customers to submit custom orders'),
                                  style: GoogleFonts.cairo(
                                    color: secondaryTextColor,
                                    fontSize: 12,
                                  ),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.festival, color: Color(0xFFD4A017), size: 24),
                          ),
                          const SizedBox(width: 14),
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  t('المعارض والفعاليات', 'Exhibitions & Events'),
                                  style: GoogleFonts.cairo(
                                    color: primaryTextColor,
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                ...
                                Text(
                                  t('شارك في المعارض القادمة أو اعرض معارضك الحالية', 'Participate in upcoming exhibitions or view your current ones'),
                                  style: GoogleFonts.cairo(
                                    color: secondaryTextColor,
                                    fontSize: 12,
                                  ),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          isArabic ? "طلبات متاحة لمجالك" : "Available Orders in your field",
                          style: GoogleFonts.arefRuqaa(
                            color: primaryTextColor,
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                        ...
                        Icon(Icons.bolt, color: const Color(0xFFD4A017), size: 24),
                      ],
                    ),
                    const SizedBox(height: 15),
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.add_photo_alternate_outlined, color: const Color(0xFFD4A017), size: 36),
                const SizedBox(height: 8),
                Text(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 14,
                          backgroundColor: const Color(0xFFD4A017).withValues(alpha: 0.12),
                          child: const Icon(Icons.person, size: 16, color: Color(0xFFD4A017)),
                        ),
                        const SizedBox(width: 8),
                        Text(
                          client,
                          style: TextStyle(color: secondaryTextColor, fontSize: 12.5, fontWeight: FontWeight.w600),
                        ),
                      ],
                    ),
                    Text(
                      time,
                      style: TextStyle(color: secondaryTextColor.withValues(alpha: 0.6), fontSize: 11),
                    ),
                  ],
                ),
                const SizedBox(height: 12),
                Text(
                  title,
                  style: TextStyle(color: primaryTextColor, fontSize: 15.5, fontWeight: FontWeight.bold),
                ),
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          ...
                          style: const TextStyle(color: Color(0xFFD4A017), fontSize: 13, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                  ],
        ...
        child: Row(
          ...
          children: [
            ...
            if (label.isNotEmpty) ...[
              ...
              Text(
                label,
                style: TextStyle(color: topIconColor, fontSize: 13, fontWeight: FontWeight.w600),
              ),
            ],
          ],
        ),
