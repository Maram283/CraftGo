...
class _ClientDashboardState extends State<ClientDashboard> {
  ...
  final PageController _categoryPageController = PageController(viewportFraction: 0.42);
  int _categoryPage = 0;
  ...
  void initState() {
    ...
    // Start auto-scroll for categories after first frame
    WidgetsBinding.instance.addPostFrameCallback((_) => _startCategoryAutoScroll());
  }
  ...
  void _startCategoryAutoScroll() {
    Future.doWhile(() async {
      ...
      final next = (_categoryPage + 1) % categories.length;
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        // FABs removed — actions live in search bar row
        body: SafeArea(
          child: Scrollbar(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        _SearchActionBtn(
                          ...
                          color: activeFilterCount > 0 ? const Color(0xFFD4A017) : topIconColor,
                          ...
                          border: activeFilterCount > 0 ? const Color(0xFFD4A017) : cardBorderColor,
                        ...
                        //   color: const Color(0xFFD4A017),
                        //   bg: const Color(0xFFD4A017).withValues(alpha: 0.12),
                        //   border: const Color(0xFFD4A017).withValues(alpha: 0.3),
                        //   onTap: widget.isGuest ? _showGuestPrompt : _openAIOrderCreator,
                        // ),
                        // const SizedBox(width: 8),
                        // Gift Assistant
                        _SearchActionBtn(
                          ...
                          bg: isDarkMode ? Colors.white.withValues(alpha: 0.05) : Colors.white,
                          border: cardBorderColor,
                          onTap: widget.isGuest ? _showGuestPrompt : _showGiftAssistant,
                        ),
                      ],
                    ),
                    const SizedBox(height: 20),
                    ...
                    // Categories Carousel — auto-rotating rectangles
                    SizedBox(
                      height: 72,
                      child: PageView.builder(
                        controller: _categoryPageController,
                        itemCount: categories.length,
                        onPageChanged: (i) => setState(() => _categoryPage = i),
                        itemBuilder: (context, index) {
                          final cat = categories[index];
                          final isSelected =
                              _categoryPage == index ||
                                  (selectedFilterIndex == null && index == 0 && _categoryPage == 0);
                          return GestureDetector(
                            onTap: () {
                              setState(() {
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  width: 34, height: 34,
                  decoration: BoxDecoration(
                    color: isDarkMode ? const Color(0xFF0D1420).withValues(alpha: 0.7) : Colors.white.withValues(alpha: 0.85),
                    shape: BoxShape.circle,
                  ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.star_rounded, color: Color(0xFFF7B500), size: 14),
                    const SizedBox(width: 3),
                    Text(rating, style: TextStyle(color: secondaryTextColor, fontSize: 12, fontWeight: FontWeight.w600)),
                    const Spacer(),
                    Text(
...
// ── Compact icon button used in the search bar row ───────────────────────────
